...
namespace GuniKitchenProject.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderNo,UserId,ProductId")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderNo,UserId,ProductId")] Order order)
        {
            if (id != order.OrderNo)
            {
                return NotFound();
        ...
        {
            return _context.Orders.Any(e => e.OrderNo == id);
        }
    }
}
